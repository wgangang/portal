    ...
    sys.dict.dictMain = function(){
        ...
        this.plusFun = function(){
           if(obj.curSelTree.id == undefined ){
            ...
            saicfc.win.show("字典新增","system/dict/dictManage.html?parentId=" + obj.curSelTree.id,700,400,false);
        }
        ...
        this.editFun = function(){
            ...
            saicfc.win.show("字典修改","system/dict/dictManage.html?dictId=" + selRows[0].dictId,700,400,false);
        }
